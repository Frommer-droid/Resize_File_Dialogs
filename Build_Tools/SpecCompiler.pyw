...
from binary_policy import minimal_build_env  # noqa: E402
    ...
    def _apply_styles(self):
        self.setStyleSheet(
            ...
            QComboBox QAbstractItemView {{
                ...
                selection-color: {self.colors['text_strong']};
            }}
            QPushButton {{
                border-radius: 8px;
            ...
            QPushButton:hover {{
                ...
                border-color: {self.colors['focus']};
            }}
            QPushButton#build_btn:hover {{ background-color: {self.colors['accent_hover']}; }}
            QPushButton:pressed {{ background-color: {self.colors['surface_pressed']}; }}
            QPushButton:disabled {{ background-color: {self.colors['disabled_background']}; color: {self.colors['disabled_text']}; }}
            QStatusBar {{
                background-color: {self.colors['surface']};
                color: {self.colors['text_strong']};
            }}
