...
class AhkResizerGenerator(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"Python AHK Resizer Generator v{__version__}")
    ...
    def _apply_styles(self):
        ...
        qss = f"""
            ...
            QMainWindow, QMenu {{ background-color: #282C34; }}
            QGroupBox {{
                ...
                border: {scale_px(1, scale_factor)}px solid #4BAA9F;
                border-radius: {scale_px(5, scale_factor)}px;
            }}
            QGroupBox::title {{
            ...
            QPushButton {{
                background-color: #3AE2D0; color: #1E1E1E; border: none;
                padding: {scale_px(8, scale_factor)}px {scale_px(16, scale_factor)}px;
                border-radius: {scale_px(4, scale_factor)}px;
                font-weight: bold;
            }}
            QPushButton:hover {{ background-color: #6AF1E2; }}
            QPushButton:pressed, QPushButton:checked {{ background-color: #139385; color: #FFFFFF; }}
            QPushButton:disabled {{ background-color: #555555; color: #888888; }}
            QLineEdit, QTextEdit, QSpinBox, QComboBox {{
                background-color: #333942;
                border: {scale_px(1, scale_factor)}px solid #4B82E5;
                border-radius: {scale_px(4, scale_factor)}px;
                padding: {scale_px(5, scale_factor)}px;
                color: #E0E0E0;
            }}
            QLineEdit:focus, QTextEdit:focus, QSpinBox:focus, QComboBox:focus {{
                border: {scale_px(2, scale_factor)}px solid #78A3F2;
            }}
            QListWidget {{
                background-color: #333942;
                border: {scale_px(1, scale_factor)}px solid #4B82E5;
            }}
            QListWidget::item:selected {{ background-color: #4B82E5; color: #FFFFFF; font-weight: bold; }}
            ...
            QTabBar::tab {{
                ...
                border-top-left-radius: {scale_px(4, scale_factor)}px;
                border-top-right-radius: {scale_px(4, scale_factor)}px;
            }}
            QTabBar::tab:selected {{ background-color: #4B82E5; color: #FFFFFF; font-weight: bold; }}
            QTabBar::tab:!selected {{ color: #99B8F2; }}
            QSplitter::handle {{ background-color: #4BAA9F; }}
            ...
            QComboBox QAbstractItemView {{
                background-color: #333942;
                color: #E0E0E0;
                selection-background-color: #4B82E5;
            ...
            QStatusBar {{
                background-color: #282C34;
                color: #E0E0E0;
                border-top: {scale_px(1, scale_factor)}px solid #4BAA9F;
            }}
            QStatusBar QLabel {{
                background-color: transparent;
            }}
            QMenu::item:selected {{ background-color: #4B82E5; }}
        ...
        admin_color = "lime" if self._check_admin_rights() else "#FF9241"
...
"""
    ...
    def log_message(self, message: str, level: str = "normal"):
        color_map = {"normal": "white", "info": "#87CEEB", "success": "lime", "warn": "#FFBC41", "error": "#FF4C4C"}
    ...
    def _populate_ui_from_settings(self):
        ...
        for i, rule in enumerate(self.rules):
            ...
            if not rule.get("enabled", True):
                item.setForeground(QBrush(QColor("#8A8F99")))
